...
bot = telebot.TeleBot("570652208:AAEeFTbltYSt4i0379jU5nDFKrQSShLsydc")
...
@bot.message_handler(func=lambda message: message.entities is not None and message.chat.id == 1265476411)
...
@bot.message_handler(func=lambda message: message.text and message.text.lower() in restricted_messages and message.chat.id == 1265476411)
def set_ro(message):
